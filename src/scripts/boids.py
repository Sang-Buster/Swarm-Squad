...
class Flock:
    def __init__(self, num_boids):
        ...
        self.x_center = (29.187 + 29.194) / 2
        self.y_center = (-81.052 + -81.044) / 2
        self.z_center = (5 + 50) / 2
                    
    def update_boids(self):
        for boid in self.boids:
            v1 = self.rule1(boid) * 0.1
            v2 = self.rule2(boid) * 0.5
            v3 = self.rule3(boid) * 0.1
        ...
        for boid in self.boids:
            ...
            boid.position[0] = self.x_center + boid.position[0] * (29.194 - 29.187)
            boid.position[1] = self.y_center + boid.position[1] * (-81.044 - -81.052)
    ...
    def rule2(self, boid):
        ...
        for other_boid in self.boids:
            if other_boid != boid and np.linalg.norm(other_boid.position - boid.position) < 10:  # Increase separation distance
