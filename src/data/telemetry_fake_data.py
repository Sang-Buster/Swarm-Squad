...
telemetry_columns = ['Agent Name', 'Location', 'Destination', 'Altitude', 'Airspeed/Velocity', 'Acceleration', 'Angular Velocity']
...
while True:
    ...
    # Create a dataframe
    telemetry_df = pd.DataFrame(list(zip(agent_name, location, destination, altitude, airspeed_velocity, acceleration, angular_velocity)), columns=telemetry_columns)
